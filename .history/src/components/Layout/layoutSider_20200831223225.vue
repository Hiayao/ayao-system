...
export default {
  ...
  methods: {
    ...
    addNav(item){
      console.log(item);
      localStorage.setItem(`${this.user.username}Nav`,item.authName)
    },
  },
  mounted() {
    this.getMenus();
    this.user = JSON.parse(localStorage.getItem('user'))
    if(localStorage.get(`${this.user.username}Nav`)){
      this.authList = localStorage.getItem(`${this.user.username}Nav`)
