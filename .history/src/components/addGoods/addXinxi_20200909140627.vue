...
export default {
  ...
  methods: {
    ...
    handleChange(value) {
      ...
      if (value) {
        this.fleg = true;
        this.$emit("nexts",[this.fleg,id,this.form.name,this.form.price,this.form.weight,this.form.num,value])
      }
    },
    input(e) {
      console.log(e);
    ...
    inputss(e) {
      console.log(e);
      if (this.form.weight !== "" && this.disabled === false && this.disableds === false) {
        this.disabledss = false;
      }
      if (this.form.weight === "" || this.disabled === true || this.disableds === true) {
        this.disabledss = true;
      }
    },
    inputsss(e) {
      console.log(e);
      if (this.form.num !== "" && this.disabled === false && this.disableds === false && this.disabledss === false) {
        this.disabledsss = false;
      }
      if (this.form.num === "" || this.disabled === true || this.disableds === true || this.disabledss === true) {
