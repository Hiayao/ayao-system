    ...
    <div class="box">
      ...
      >
        ...
        <template v-slot:action="scope">
          ...
          <el-tag v-if="scope.scope.row.level ==='0'">标签一</el-tag>
          <el-tag type="success" v-if="scope.scope.row.level ==='1'">标签二</el-tag>
          <el-tag type="warning" v-if="scope.scope.row.level ==='2'">标签四</el-tag>
        </template>
      </ug-table>
    </div>
  </div>
