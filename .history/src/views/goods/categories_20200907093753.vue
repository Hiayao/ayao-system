  ...
  <div>
    <div class="box">
      ...
      <template v-slot:goodsName="scope">
         <el-tree :data="sortList[index]"  v-for="(item,index) in sortList" :props="defaultProps" v-if="scope.scope.row.children" @node-click="handleNodeClick" :key="index"></el-tree>
        </template>
