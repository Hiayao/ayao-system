<template>
  <div>
    <div class="box">
      ...
      >
      <template v-slot:goodsName="scope"  v-if="scope.scope.row.children">
         <el-tree :data="sortList[index]"  v-for="(item,index) in sortList" :props="defaultProps" @node-click="handleNodeClick" :key="index"></el-tree>
        </template>
