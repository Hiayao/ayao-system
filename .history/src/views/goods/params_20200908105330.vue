  ...
  <div class="box">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="动态参数" name="first">
        <el-button type="primary" size="small" disabled v-if="!attributes">添加参数</el-button>
        <el-button type="primary" size="small" @click="addAttributes" v-if="attributes">添加参数</el-button>
      </el-tab-pane>
