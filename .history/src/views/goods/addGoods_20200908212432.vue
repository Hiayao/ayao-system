    ...
    <div class="box">
      ...
      <div>
        ...
        <el-tabs tab-position="left" v-model="tab">
          ...
          <el-tab-pane label="商品属性" :disabled="disableds">角色管理</el-tab-pane>
          <el-tab-pane label="商品图片" :disabled="disabledss">定时任务补偿</el-tab-pane>
          <el-tab-pane label="商品内容" :disabled="disabledsss">定时任务补偿</el-tab-pane>
        </el-tabs>
      </div>
    </div>
  </div>
